      ...
      <aside className="flex w-[260px] flex-shrink-0 flex-col border-r border-black/5 bg-surface-sidebar">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-3">
          ...
          <div className="flex flex-col items-center justify-center py-6 text-center">
            <div className="mb-2 flex h-9 w-9 items-center justify-center rounded-2xl bg-surface-hover">
              <MessageSquare className="h-4 w-4 text-ink-tertiary" />
            </div>
            <p className="text-xs text-ink-tertiary">暂无面试记录</p>
            <Link href="/sessions" className="mt-1 text-[11px] text-brand-700 hover:underline">
              查看全部会话 →
            </Link>
          </div>
        </div>
